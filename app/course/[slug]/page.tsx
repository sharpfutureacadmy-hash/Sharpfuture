...
import { courseData, getCourseBySlugOrId } from "@/lib/course";
...
export async function generateMetadata({
  ...
  const course = getCourseBySlugOrId(slug);
  ...
  const courseUrl = `${SITE_CONFIG.url}/course/${course.slug}`;
...
export default async function CoursePage({
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: course.title, url: `${SITE_CONFIG.url}/course/${course.slug}` },
  ]);
